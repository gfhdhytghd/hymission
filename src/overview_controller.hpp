...
class OverviewController {
  ...
  private:
    ...
    struct State {
        ...
        std::optional<std::size_t>             hoveredCloseIndex;
    ...
    [[nodiscard]] bool         backgroundBlurEnabled() const;
    [[nodiscard]] double       backgroundBlurAlpha() const;
    ...
    bool                     m_closeButtonPressLatched = false;
    bool                     m_closeCursorOverride = false;
