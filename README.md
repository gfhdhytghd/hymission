...
- **Type-to-Search**: Filter windows instantly by typing their title or class while overview is active
...
| `background_blur` | bool | `1` | Enable Gaussian blur on the overview backdrop. |
| `background_blur_alpha` | float | `0.70` | Alpha value for the backdrop color when blur is enabled. |
| `show_titles` | bool | `0` | Always show window titles for all previews, not just the selected one. |
